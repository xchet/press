        ...
        <div class="site-section">
            <div class="container">
                <div class="half-post-entry d-block d-lg-flex bg-light">
                    <div class="img-bg" style="background-image:url('{{ asset('content') }}/images/xbig_img_1.jpg.pagespeed.ic.UKA_TdMRvl.jpg')"></div>
                    <div class="contents">
                        ...
                        <div class="post-meta">
                            <span class="d-block"><a href="index.html#">Dave Rogers</a> in <a href="index.html#">Food</a></span>
